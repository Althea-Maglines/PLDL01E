class Employee:
    ...
    def __init__(self):
        ...
        self.salary_cut_off = input("Enter Salary Cut-Off Date: ")
        ...
        self.emp_num_of_tardiness = int(input("Employee tardiness: "))
    ...
    def emp_salary_computation(self):
        ...
        self.emp_tardiness = self.emp_num_of_tardiness * self.emp_rate_per_hour

    def emp_sss_contribution(self):
        #Setting copdition for Employee's Gross Earnings to get the SSS, Tax, and Philhealth Contribution
        ...
        elif self.emp_gross_earnings >= 28250 and self.emp_gross_earnings < 20749.99:
            self.sss_contribution = 900.00
        elif self.emp_gross_earnings >= 28750 and self.emp_gross_earnings < 21249.99:
            self.sss_contribution = 900.00
