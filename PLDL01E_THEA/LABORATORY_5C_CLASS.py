...
def student_information():
    ...
    print(f"                                                            | {'ASSESSMENT OF FEES':^{assessment_width + unit_width}}")
    print(f"                                                            | {'-' * (assessment_width + unit_width)}")

# Displaying Assessment Fee
def subject_assessment_fee():

    print(f"                                                            | {'Tuition Fee Lecture:':<{assessment_width}} {assessment.tuition_fee():>{unit_width - 5}}")
    print(f"                                                            | {'LPU Chronicle:':<{assessment_width}} {assessment.chronicle:>{unit_width - 5}}")
    print(f"                                                            | {'Athletic:':<{assessment_width}} {assessment.athletic:>{unit_width - 5}}")
    print(f"                                                            | {'Audio Visual Library:':<{assessment_width}} {assessment.audio_visual_library:>{unit_width - 5}}")
    print(f"                                                            | {'LycesGo:':<{assessment_width}} {assessment.ausg:>{unit_width - 5}}")
    print(f"                                                            | {'Cultural Fee:':<{assessment_width + 1}} {assessment.cultural_fee:<{unit_width}}")
