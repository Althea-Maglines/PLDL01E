...
from PLDL01E_THEA.LABORATORY_5_CLASS import Student
...
def display_assessment_fee():
    ...
    print(f"Recognized Student Fee: {assessment.rso:<{unit_width}}")
